...
export default function Footer() {
  ...
  const socialLinks = [
    { href: "https://www.youtube.com/@ijekerTech", icon: <FaYoutube />, hover: "hover:text-red-500" },
    { href: "https://facebook.com/profile.php?id=61579048111215", icon: <FaFacebook />, hover: "hover:text-blue-600" },
    { href: "https://www.linkedin.com/company/ijekertech", icon: <FaLinkedinIn />, hover: "hover:text-blue-800" },
    { href: "https://instagram.com/ijekertech", icon: <FaInstagram />, hover: "hover:text-pink-500" },
    { href: "https://twitter.com/ijekertech", icon: <FaXTwitter />, hover: "hover:text-black" },
  ];

  const quickLinks = [
    { name: "Home", link: "/" },
    { name: "About Us", link: "company/about" },
    { name: "Blog", link: "blog/BlogPage" },
  ...
  return (
    <>
      <section className="bg-gradient-to-r from-gray-50 via-gray-100 to-gray-50 animate-gradient-x" data-aos="fade-up">
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8 max-w-7xl mx-auto py-12 px-6">
          ...
          <div>
            ...
            <p className="text-gray-600 mt-3 text-center md:text-left leading-relaxed">
              At ijekerTech, we deliver cutting-edge digital solutions that empower businesses, enhance user experience, and drive innovation globally.
            </p>
