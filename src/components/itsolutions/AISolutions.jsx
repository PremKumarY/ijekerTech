  ...
  return (
    <>
      ...
      <section className="bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-20 px-6 text-center relative overflow-hidden">
        ...
        >
          Empower your business with next-gen Artificial Intelligence solutions
      ...
      <nav className="max-w-6xl mx-auto px-4 py-3 text-sm text-gray-600">
        ...
        / <span className="text-gray-500">IT Solution / AI Solutions</span>
      </nav>
      ...
      <div className="bg-gray-50 py-20 px-6 lg:px-20">
        <div className="grid sm:grid-cols-2 lg:grid-cols-3 gap-10">
          {services.map((service, idx) => {
            const Icon = service.icon; // ✅ Fixed JSX icon usage
            return (
              <motion.div
                key={idx}
      ...
      <div className="relative bg-gradient-to-r from-blue-600 to-purple-600 py-20 text-center text-white px-2 rounded-t-3xl overflow-hidden">
        ...
        >
          Let’s bring your AI vision to life. Contact us to discuss your project
          today.
        </motion.p>
        <motion.a
          href="/contact"
          className="inline-block bg-white text-blue-700 font-medium px-8 py-3 rounded-full shadow-lg hover:shadow-xl transform hover:scale-105 transition"
