...
import { FaTasks, FaUsers, FaCertificate } from "react-icons/fa";
  ...
  const internshipCards = [
    {
      ...
      desc: "Work on industry-level projects with real-world impact."
    },
    {
      title: "Team Collaboration",
      color: "from-green-500 to-emerald-600",
      icon: <FaUsers size={40} />,
      desc: "Collaborate with peers, mentors, and industry experts."
    },
    {
      title: "Certification",
  ...
  return (
    <div className="min-h-screen bg-gray-50">
      ...
      <div className="relative bg-gradient-to-r from-blue-600 to-indigo-700 text-white py-16 px-6 text-center overflow-hidden">
        ...
        >
          Gain practical experience and skills with{" "}
      ...
      <div className="bg-gradient-to-r from-indigo-600 to-purple-700 py-10 text-center text-white">
        <h3 className="text-2xl font-semibold">Kickstart Your Career</h3>
        <p className="mt-2 text-gray-200">
          Apply now and be a part of our Internship Program.
        </p>
        <Link
          to="/apply-internship"
